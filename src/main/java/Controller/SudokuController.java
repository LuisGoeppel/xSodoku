...
public class SudokuController {
    ...
    public void generateNew() {
        sudoku = new Sudoku("-6-9---1-/--34--97-/-2-7-----/------2-7/--2--1--8/-8---5-3-/---------/-3---6-9-/4--1---8-"); // Harder
        //sudoku = new Sudoku("--3------/7--2---3-/-9-137-2-/----6--7-/3--9-56--/--67-14--/---47-5-1/--4--2---/-3--18-4-"); // Hard
        //sudoku = new Sudoku("-4-185---/-316--9--/-----7---/---92-4-6/36-------/-9------5/-2----3--/----5--1-/65-2-4---"); // Medium
        drawMatrix(sudoku.getMatrix(), sudoku.getStartNumbers());
    }
